...
import com.example.yello.inventory_mvc.fragment.RequestListFragment;
...
public class ManageRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  else
      //  {
            startListFragment(UrlString.getRequistionRecordByDept);
        //}
    }
    ...
    {
        final String TAG = "REQUEST_LIST_FRAGMENT";

        Bundle bundle = new Bundle();
        bundle.putString(Key.BUNDLE_URL, url);

        Fragment listRequestFragment = new RequestListFragment();
        ...
        {
            transaction.add(R.id.frameLayoutRequestList, listRequestFragment, TAG);
        }
        else
        {
            transaction.replace(R.id.frameLayoutRequestList, listRequestFragment, TAG);
        }
